...
<head>
    ...
    <style>
        ...
        form {
            ...
            width: 400px; /* Adjust width for larger form */
            margin: 0 auto;
            display: flex;
            flex-wrap: wrap;
...
%>
                <div>
                    <form action="UpdateServlet" method="post">
                        ...
                        <input type="date" id="dateOfBirth" name="dateOfBirth" value="<%= rs.getString("date_of_birth") %>" required>
                        ...
                        <input type="text" id="phoneNumber" name="phoneNumber" value="<%= rs.getString("phone_number") %>" required>
